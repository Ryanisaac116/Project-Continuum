...
public class SkillExchangeRequest {
    ...
    public UserSkill getSenderSkill() { return senderSkill; }
    public UserSkill getReceiverSkill() { return receiverSkill; }
    ...
    public void setSenderSkill(UserSkill senderSkill) { this.senderSkill = senderSkill; }
    public void setReceiverSkill(UserSkill receiverSkill) { this.receiverSkill = receiverSkill; }
